...
def notify():
    ...
    if tx.status == "complete":
        return "ok", 200  # already processed — duplicate webhook, no-op
...
def decide_withdrawal():
    ...
    if decision in ("approved", "rejected"):
        ...
        wr.status = "paid"
        # Real payout-API call is a drop-in here once merchant tier
        # supports disbursements; for now this marks it paid once an
        # admin confirms the manual EFT was sent.
        latest = (
