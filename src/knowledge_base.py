...
# --------------------------------------------------------------------
# The knowledge base itself. Two categories: "app" (how this specific
# product works) and "practice" (stokvel/savings-group financial best
# practice, not tied to this app). Keep each chunk focused on one idea
# — retrieval works better over many small chunks than a few huge ones.
# --------------------------------------------------------------------
DOCS = [
    # --- how this app works ---
    {
    ...
    # --- stokvel / savings-group financial best practice ---
    {
...
def _stem(token: str) -> str:
    ...
    if token.endswith("ss"):
        return token  # don't touch double-s words like "miss"/"class"
...
# Precompute TF-IDF vectors for the corpus once, at import time.
