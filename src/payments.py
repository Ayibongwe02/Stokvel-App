...
MERCHANT_ID = os.environ.get("PAYFAST_MERCHANT_ID", "10000100")  # PayFast's public sandbox merchant id
MERCHANT_KEY = os.environ.get("PAYFAST_MERCHANT_KEY", "46f0cd694581a")  # PayFast's public sandbox key
